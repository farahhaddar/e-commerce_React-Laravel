...
class OrderDetails extends Component {
  ...
  deleteOrder(e) {
    fetch("http://localhost:8000/api/OrderProducts/" + e, {
      method: "delete",
      // body: formData,
      headers: {
  ...
  search() {
    fetch(
      "http://localhost:8000/api/OrderProducts/" +
        this.state.rows +
        "?page=1&name=" +
        this.state.search1 +
        "&order_id=" +
        ...
        array.push(
          <div className={"row" + c + " rowData"}>
            <div className="col0 col4">
              {this.state.orderProducts.data[i].products.name}
            </div>
            <div className="col0 col4">
              {this.state.orderProducts.data[i].products.price}
            </div>
            <div className="col0 col4">
              {this.state.orderProducts.data[i].quantity}
            </div>
            <div className="col0 col4">Product</div>
    ...
    return (
      <div className="App">
        ...
        <Link
          className="link-to"
          to={{
            pathname: "/admin/OrderDetailsPackages",
            state: {
