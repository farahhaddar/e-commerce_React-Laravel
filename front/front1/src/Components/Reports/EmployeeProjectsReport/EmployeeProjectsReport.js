...
class EmployeeProjectsReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      role: "",
  ...
  search() {
    fetch(
      "http://localhost:8000/api/projectRole/" +
        employeeId +
        "/" +
        this.state.rows +
        "?page=1&projectName=" +
  ...
  componentDidMount() {
    ...
    this.props.title("Employee Project Report");
    let a = document.getElementsByClassName("pageOptions");
    a[0].style.display = "none";
  ...
  render() {
    ...
    let count = "";
    if (this.state.employees.data != undefined) {
      count = this.state.employees.data.length;
      for (let i = 0; i < this.state.employees.data.length; i++) {
        let c = i % 2;
        array.push(
          <div className={"row" + c + " rowData"}>
            <div className="col0 col2">
              {this.state.employees.data[i].projectName}
            </div>
            <div className="col0 col2">
              {this.state.employees.data[i].roleName}
            </div>
            <div className="col0 col2"></div>
          </div>
        );
      }
    }
      ...
      form.push(
        <form method="post" onSubmit={this.onSubmit}>
          ...
          <input
            name="email"
            id="email"
            defaultValue={this.state.employeeEdited.email}
            aria-invalid="false"
            type="text"
            onChange={this.handleInputChange}
          />
    ...
    return (
      <div className="App">
        ...
        <div className="table">
          ...
          <div>
            <div className="row1">
              <div className="col0 col2">Project</div>
              <div className="col0 col2">Role</div>
